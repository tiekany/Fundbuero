...
st.markdown(
    ...
    /* ========================================================
       STREAMLIT KOPF / FOOTER AUSBLENDEN
       ======================================================== */
...
def clean_label(label):
    """
    Entfernt Nummern am Anfang eines Labels.
...
def predict_image(image):
    ...
    try:
        ...
        # ----------------------------------------------------
        # Bekannte Teachable-Machine-Struktur
        # ----------------------------------------------------
